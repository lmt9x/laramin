...
class TestCase extends BaseTestCase
{
    ...
    public function createApplication()
    {
        ...
        $app->booting(function () {
            ...
            $loader->alias('Admin', \LaraCore\Admin\Facades\Admin::class);
        });

        $app->make('Illuminate\Contracts\Console\Kernel')->bootstrap();

        $app->register('LaraCore\Admin\AdminServiceProvider');
    ...
    protected function setUp(): void
    {
        ...
        $this->artisan('vendor:publish', ['--provider' => 'LaraCore\Admin\AdminServiceProvider']);
...
//        \LaraCore\Admin\Admin::$css = [];
//        \LaraCore\Admin\Admin::$js = [];
//        \LaraCore\Admin\Admin::$script = [];
    }
