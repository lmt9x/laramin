...
use LaraCore\Admin\Actions\Action;
use LaraCore\Admin\Actions\GridAction;
use LaraCore\Admin\Actions\Response;
use LaraCore\Admin\Actions\RowAction;
use LaraCore\Admin\Widgets\Form;
use Exception;
...
class HandleController extends Controller
{
    ...
    public function handleSelectable(Request $request)
    {
        ...
        if (class_exists($class)) {
            /** @var \LaraCore\Admin\Grid\Selectable $selectable */
