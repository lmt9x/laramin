...
namespace LaraCore\Admin\Traits;
...
trait HasAssets
{
     ...
     * @var string
     */
    public static $manifest = 'vendor/laramin/minify-manifest.json';
     ...
     */
    public static $min = [
        'js'  => 'vendor/laramin/laramin.min.js',
        'css' => 'vendor/laramin/laramin.min.css',
    ];
