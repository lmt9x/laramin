...
class ExportSeedCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'laramin:export-seed {classname=AdminTablesSeeder}
     ...
     * @var string
     */
    protected $description = 'Export seed a laramin database tables menu, roles and permissions';
