...
class AdminServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Blade::directive('box', function ($title) {
            return "<?php \$box = new \LaraCore\Admin\Widgets\Box({$title}, '";
        });
    ...
    protected function registerPublishing()
    {
        if ($this->app->runningInConsole()) {
            $this->publishes([__DIR__.'/../config' => config_path()], 'laramin-config');
            $this->publishes([__DIR__.'/../resources/lang' => resource_path('lang')], 'laramin-lang');
            $this->publishes([__DIR__.'/../database/migrations' => database_path('migrations')], 'laramin-migrations');
            $this->publishes([__DIR__.'/../resources/assets' => public_path('vendor/laramin')], 'laramin-assets');
        }
    }
