...
use Closure;
use LaraCore\Admin\Auth\Database\Menu;
use LaraCore\Admin\Controllers\AuthController;
use LaraCore\Admin\Layout\Content;
use LaraCore\Admin\Traits\HasAssets;
use LaraCore\Admin\Widgets\Navbar;
...
class Admin
{
    ...
    /**
     * Returns the long version of laramin.
     *
     * @return string The long application version
     */
    public static function getLongVersion()
    {
        return sprintf('Laramin <comment>version</comment> <info>%s</info>', self::VERSION);
    }
     ...
     * @param Closure $callable
     *
     * @return \LaraCore\Admin\Layout\Content
     *
     * @deprecated since v1.6.1
     */
     ...
     * Get navbar object.
     *
     * @return \LaraCore\Admin\Widgets\Navbar
     */
    ...
    /**
     * Register the laramin builtin routes.
     *
     * @return void
     *
    ...
    public function routes()
    {
        ...
        app('router')->group($attributes, function ($router) {
            ...
            $router->namespace('\LaraCore\Admin\Controllers')->group(function ($router) {
