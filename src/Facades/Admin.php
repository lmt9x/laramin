...
namespace LaraCore\Admin\Facades;
 ...
 * Class Admin.
 *
 * @method static \LaraCore\Admin\Grid grid($model, \Closure $callable)
 * @method static \LaraCore\Admin\Form form($model, \Closure $callable)
 * @method static \LaraCore\Admin\Show show($model, $callable = null)
 * @method static \LaraCore\Admin\Tree tree($model, \Closure $callable = null)
 * @method static \LaraCore\Admin\Layout\Content content(\Closure $callable = null)
 ...
 *
 * @see \LaraCore\Admin\Admin
 */
class Admin extends Facade
{
    protected static function getFacadeAccessor()
    {
        return \LaraCore\Admin\Admin::class;
    }
}
