...
class MultipleFile extends Field
{
    ...
    protected static $css = [
        '/vendor/laramin/bootstrap-fileinput/css/fileinput.min.css?v=4.5.2',
    ];
     ...
     */
    protected static $js = [
        '/vendor/laramin/bootstrap-fileinput/js/plugins/canvas-to-blob.min.js',
        '/vendor/laramin/bootstrap-fileinput/js/fileinput.min.js?v=4.5.2',
        '/vendor/laramin/bootstrap-fileinput/js/plugins/sortable.min.js?v=4.5.2',
    ];
