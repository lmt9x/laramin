...
namespace LaraCore\Admin\Form;

use LaraCore\Admin\Admin;
use LaraCore\Admin\Form;
use LaraCore\Admin\Widgets\Form as WidgetForm;
...
class NestedForm
{
    ...
    /**
     * @var \LaraCore\Admin\Form|\LaraCore\Admin\Widgets\Form
     */
    protected $form;
    ...
    protected function prepareRecord($record)
    {
        ...
        foreach ($this->fields as $field) {
            ...
            if (($field instanceof \LaraCore\Admin\Form\Field\Hidden) || $value != $field->original()) {
                if (is_array($columns)) {
