...
<head>
    ...
    <link href="{{ admin_asset("vendor/laramin/css/pages/login/login-1.css") }}" rel="stylesheet" type="text/css"/>
    <!--end::Page Custom Styles-->
    <!--begin::Global Theme Styles(used by all pages)-->
    <link href="{{ admin_asset("vendor/laramin/plugins/global/plugins.bundle.css") }}" rel="stylesheet"
          type="text/css"/>
    <link href="{{ admin_asset("vendor/laramin/plugins/custom/prismjs/prismjs.bundle.css") }}" rel="stylesheet"
          type="text/css"/>
    <link href="{{ admin_asset("vendor/laramin/css/style.bundle.css") }}" rel="stylesheet" type="text/css"/>
    <!--end::Global Theme Styles-->
    <!--begin::Layout Themes(used by all pages)-->
    <link href="{{ admin_asset("vendor/laramin/css/themes/layout/header/base/light.css") }}" rel="stylesheet"
          type="text/css"/>
    <link href="{{ admin_asset("vendor/laramin/css/themes/layout/header/menu/light.css") }}" rel="stylesheet"
          type="text/css"/>
    <link href="{{ admin_asset("vendor/laramin/css/themes/layout/brand/dark.css") }}" rel="stylesheet" type="text/css"/>
    <link href="{{ admin_asset("vendor/laramin/css/themes/layout/aside/dark.css") }}" rel="stylesheet" type="text/css"/>
    <!--end::Layout Themes-->
    ...
    <div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
        ...
        <div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #F2C98A;">
            ...
            <div class="aside-img d-flex flex-row-fluid bgi-no-repeat bgi-position-y-bottom bgi-position-x-center"
                 style="background-image: url({{ admin_asset("vendor/laramin/media/svg/illustrations/login-visual-1.svg") }})"></div>
            <!--end::Aside Bottom-->
        </div>
        <!--begin::Aside-->
        <!--begin::Content-->
...
<script src="{{ admin_asset("vendor/laramin/plugins/global/plugins.bundle.js") }}"></script>
<script src="{{ admin_asset("vendor/laramin/plugins/custom/prismjs/prismjs.bundle.js") }}"></script>
<script src="{{ admin_asset("vendor/laramin/js/scripts.bundle.js") }}"></script>
<!--end::Global Theme Bundle-->
<!--begin::Page Scripts(used by this page)-->
<script src="{{ admin_asset("vendor/laramin/js/pages/custom/login/login-general.js") }}"></script>
<!--end::Page Scripts-->
</body>
</html>
