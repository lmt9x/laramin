        ...
        @else
            <div class="dropdown" id="kt_quick_search_toggle">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    @include('admin::partials.extras.dropdown.search-dropdown')
                </div>
            </div>
        @endif
    @endif
    ...
    @if (config('layout.extras.notifications.display'))
        ...
        @else
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <form>
                        @include('admin::partials.extras.dropdown.notifications')
                    </form>
                </div>
            </div>
        @endif
    ...
    @if (config('layout.extras.quick-actions.display'))
        ...
        @else
            <div class="dropdown">
                ...
                {{-- Dropdown --}}
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    @include('admin::partials.extras.dropdown.quick-actions')
                </div>
            </div>
        @endif
    @endif
    ...
    @if (config('layout.extras.cart.display'))
        <div class="dropdown">
            ...
            <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-xl dropdown-menu-anim-up">
                <form>
                    @include('admin::partials.extras.dropdown.cart')
                </form>
            </div>
        </div>
    @endif
    ...
    @if (config('layout.extras.languages.display'))
        <div class="dropdown">
            ...
            <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                @include('admin::partials.extras.dropdown.languages')
            </div>
        </div>
    @endif
        ...
        @else
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg p-0">
                    @include('admin::partials.extras.dropdown.user')
                </div>
            </div>
        @endif
    @endif
